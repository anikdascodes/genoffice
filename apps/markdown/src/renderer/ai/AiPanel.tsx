...
/** Neutral AI entry icon, inline for crisp device-resolution rendering */
export function AiSparkle({ size = 18 }: { size?: number }): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
