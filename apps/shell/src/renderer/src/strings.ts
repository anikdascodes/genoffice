...
export const strings = {
  zh: {
    ...
    onbNote3: 'AI 使用你自己的 API 密钥 — **自带密钥**即可使用任何模型。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    onbCredits: 'Join the community and **shape what comes next**',
    ...
    onbNote3: 'AI runs on your own API keys — **bring your own key** for every model.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    onbCredits: 'コミュニティに参加して、**次の一歩を一緒に決めましょう**',
    ...
    onbNote3: 'AI はお手持ちの API キーで動作します — **どのモデルも自分でキーを用意します**。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    onbCredits: '커뮤니티에 가입하고 **다음 단계를 함께 만들어가세요**',
    ...
    onbNote3: 'AI는 본인의 API 키로 동작합니다 — **어떤 모델이든 키를 직접 준비하세요**.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    onbCredits: 'Rejoignez la communauté et **décidez de la suite**',
    ...
    onbNote3: 'L\'IA fonctionne avec vos propres clés API — **apportez votre clé** pour chaque modèle.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    onbCredits: 'Tritt der Community bei und **gestalte die Zukunft mit**',
    ...
    onbNote3: 'KI läuft mit deinen eigenen API-Schlüsseln — **bring für jedes Modell deinen Schlüssel mit**.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    onbCredits: 'Únete a la comunidad y **decide qué viene después**',
    ...
    onbNote3: 'La IA usa tus propias claves API — **trae tu propia clave** para cada modelo.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    onbCredits: 'เข้าร่วมชุมชนและ **ร่วมกำหนดก้าวต่อไป**',
    ...
    onbNote3: 'AI ทำงานด้วยคีย์ API ของคุณเอง — **นำคีย์ของคุณเอง**มาสำหรับทุกโมเดล',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    onbCredits: 'Bergabunglah dengan komunitas dan **tentukan langkah selanjutnya**',
    ...
    onbNote3: 'AI berjalan dengan kunci API milik Anda — **bawa kunci sendiri** untuk setiap model.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    onbCredits: 'Присоединяйтесь к сообществу и **решайте, что будет дальше**',
    ...
    onbNote3: 'ИИ работает на ваших собственных API-ключах — **свой ключ для каждой модели**.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    onbCredits: 'انضم إلى المجتمع **وحدّد ما سيأتي بعد ذلك**',
    ...
    onbNote3: 'يعمل الذكاء الاصطناعي بمفاتيح API الخاصة بك — **أحضر مفتاحك الخاص** لكل نموذج.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    onbCredits: 'Junte-se à comunidade e **decida o que vem a seguir**',
    ...
    onbNote3: 'A IA usa suas próprias chaves de API — **traga sua chave** para cada modelo.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    onbCredits: 'Unisciti alla community e **decidi cosa verrà dopo**',
    ...
    onbNote3: 'L\'IA funziona con le tue chiavi API — **porta la tua chiave** per ogni modello.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    onbCredits: 'Dołącz do społeczności i **kształtuj to, co będzie dalej**',
    ...
    onbNote3: 'AI działa na Twoich własnych kluczach API — **przynieś własny klucz** dla każdego modelu.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    onbCredits: 'Word lid van de community en **bepaal wat hierna komt**',
    ...
    onbNote3: 'AI draait op je eigen API-sleutels — **breng je eigen sleutel** mee voor elk model.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    onbCredits: 'Sertai komuniti dan **bentuk apa yang akan datang**',
    ...
    onbNote3: 'AI berjalan dengan kunci API anda sendiri — **bawa kunci sendiri** untuk setiap model.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    onbCredits: 'הצטרפו לקהילה **והשפיעו על מה שיבוא אחר כך**',
    ...
    onbNote3: 'AI פועל עם מפתחות ה-API שלכם — **הביאו מפתח משלכם** לכל מודל.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    onbCredits: 'समुदाय में शामिल हों और **अगला कदम खुद तय करें**',
    ...
    onbNote3: 'AI आपकी अपनी API कुंजियों से चलता है — **हर मॉडल के लिए अपनी कुंजी लाएँ**।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
