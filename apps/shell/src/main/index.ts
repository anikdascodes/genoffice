...
// The community/site page opened from the onboarding's second slide.
const GENTEAM_URL = 'https://genoffice.ai'

const tMain = createI18n({
  zh: {
    pdfDocxUnavailable: '“导出为 Word”曾经依赖一项已下线的云端服务。此功能已不可用。',
    menuFile: '文件',
    menuSectionNew: '新建',
    menuNewDoc: 'AI Docs',
  ...
  en: {
    pdfDocxUnavailable: 'Export as Word used a hosted conversion service that this build no longer includes. The feature is unavailable.',
    menuFile: 'File',
    menuSectionNew: 'New',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  ja: {
    pdfDocxUnavailable: 'Word への書き出しは、このビルドに含まれないホスティングされた変換サービスを使用していました。現在この機能は利用できません。',
    menuFile: 'ファイル',
    menuSectionNew: '新規作成',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  ko: {
    pdfDocxUnavailable: 'Word로 내보내기는 이 더 이상 포함되지 않은 호스팅 변환 서비스를 사용했습니다. 이 기능은 현재 사용할 수 없습니다.',
    menuFile: '파일',
  ...
  fr: {
    pdfDocxUnavailable: 'L\'export Word utilisait un service de conversion hébergé qui n\'est plus inclus dans cette version. Cette fonctionnalité n\'est pas disponible.',
    menuFile: 'Fichier',
  ...
  de: {
    pdfDocxUnavailable: 'Der Word-Export nutzte einen gehosteten Konvertierungsdienst, der in diesem Build nicht mehr enthalten ist. Die Funktion ist nicht verfügbar.',
    menuFile: 'Datei',
    menuSectionNew: 'Neu',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  es: {
    pdfDocxUnavailable: 'La exportación a Word usaba un servicio de conversión en la nube que esta versión ya no incluye. La función no está disponible.',
    menuFile: 'Archivo',
  ...
  th: {
    pdfDocxUnavailable: 'การส่งออกเป็น Word เคยใช้บริการแปลงไฟล์บนคลาวด์ที่ไม่ได้รวมอยู่ในบิลด์นี้แล้ว ฟีเจอร์นี้จึงไม่สามารถใช้งานได้',
    menuFile: 'ไฟล์',
  ...
  id: {
    pdfDocxUnavailable: 'Ekspor sebagai Word sebelumnya memakai layanan konversi berbasis cloud yang tidak lagi disertakan di build ini. Fitur ini tidak tersedia.',
    menuFile: 'File',
    menuSectionNew: 'Baru',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  ru: {
    pdfDocxUnavailable: 'Экспорт в Word использовал облачный сервис конвертации, которого больше нет в этой сборке. Функция недоступна.',
    menuFile: 'Файл',
  ...
  ar: {
    pdfDocxUnavailable: 'كانت ميزة «التصدير إلى Word» تعتمد على خدمة تحويل مستضافة لم تعد مضمّنة في هذا الإصدار. هذه الميزة غير متاحة.',
    menuFile: 'ملف',
    menuSectionNew: 'جديد',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  pt: {
    pdfDocxUnavailable: 'A exportação para Word usava um serviço de conversão hospedado que não está mais incluído nesta build. O recurso não está disponível.',
    menuFile: 'Arquivo',
    menuSectionNew: 'Novo',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  it: {
    pdfDocxUnavailable: 'L\'esportazione in Word usava un servizio di conversione ospitato che non è più incluso in questa build. La funzione non è disponibile.',
    menuFile: 'File',
  ...
  pl: {
    pdfDocxUnavailable: 'Eksport do Worda korzystał z hostowanej usługi konwersji, której ta kompilacja już nie zawiera. Ta funkcja jest niedostępna.',
    menuFile: 'Plik',
    menuSectionNew: 'Nowy',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  nl: {
    pdfDocxUnavailable: 'Exporteren als Word gebruikte een gehoste conversieservice die niet langer in deze build is opgenomen. De functie is niet beschikbaar.',
    menuFile: 'Bestand',
  ...
  ms: {
    pdfDocxUnavailable: 'Eksport sebagai Word sebelum ini menggunakan perkhidmatan penukaran hos yang tidak lagi disertakan dalam binaan ini. Ciri ini tidak tersedia.',
    menuFile: 'Fail',
  ...
  he: {
    pdfDocxUnavailable: 'ייצוא ל-Word השתמש בשירות המרה מתארח שאינו כלול עוד בבנייה זו. התכונה אינה זמינה.',
    menuFile: 'קובץ',
    menuSectionNew: 'חדש',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  hi: {
    pdfDocxUnavailable: 'वर्ड के रूप में निर्यात एक होस्ट की गई रूपांतरण सेवा का उपयोग करता था जो अब इस बिल्ड में शामिल नहीं है। यह सुविधा उपलब्ध नहीं है।',
    menuFile: 'फ़ाइल',
    menuSectionNew: 'नया',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
  ...
  'zh-TW': {
    pdfDocxUnavailable: '「匯出為 Word」過去依賴的一項雲端服務已下線，此功能已不可用。',
    menuFile: '檔案',
    menuSectionNew: '新增',
    menuNewDoc: 'AI Docs',
    menuNewSheet: 'AI Sheets',
